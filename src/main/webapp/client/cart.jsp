					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								...
								<table width="100%" border="0" cellspacing="0">
									<tr>
										<td><h2>购物车中心——选购商品-》结算-》生成订单</h2></td>
									</tr>
									<tr>
										<td>
											...
											<c:forEach items="${cart}" var="entry" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="30%">${entry.key.artsname }</td>
														<td width="10%">${entry.key.price }</td>
														<td width="20%">
														    <!-- 减少商品数量 -->
															<input type="button" value='-' style="width:20px"
															       onclick="changeProductNum('${entry.value-1}','${entry.key.storenum}','${entry.key.artsid}')">
															 <!-- 商品数量显示 -->
														...
														<td width="10%">${entry.key.storenum}</td>
														<td width="10%">${entry.key.price*entry.value}</td>
														<td width="10%">
														    <!-- 删除商品 -->
															<a href="${pageContext.request.contextPath}/changeCart?id=${entry.key.artsid}&count=0"
