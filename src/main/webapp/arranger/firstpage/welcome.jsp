...
<head>
    ...
    <link href="${pageContext.request.contextPath}/arranger/css/Style.css" type="text/css" rel="stylesheet" />
<style type="text/css">
</style>
<style>
...
<form name="Form1" method="post" id="Form1">
	<table width="100%" border="0" height="88" background="${pageContext.request.contextPath}/arranger/images/back1.jpg">
		<tr>
