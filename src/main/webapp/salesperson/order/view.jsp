...
<HEAD>
	...
	<LINK href="${pageContext.request.contextPath}/salesperson/css/Style.css" type="text/css" rel="stylesheet">
...
<body>
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">${order.orderid}</td>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">${order.receivertel }</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">送货地址：</td>
			<td class="ta_01" bgColor="#ffffff">${order.receiveraddr}</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">总价：</td>
			<td class="ta_01" bgColor="#ffffff">${order.totalprice }</td>
		</tr>
		<tr>
			...
			<TD class="ta_01" bgColor="#ffffff" colSpan="3">
				<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
					...
					<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
						...
						<td align="center" width="8%">商品名称</td>
					...
					<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #eeeeee">
						<td width="8%" align="center">
							<img src="${pageContext.request.contextPath}${arts.imgurl}" width="50" height="50">
						</td>
						<td align="center" width="18%">${arts.artsid }</td>
						<td align="center" width="8%">${arts.artsname }</td>
						<td align="center" width="5%">${arts.price }</td>
						<td width="7%" align="center">${order.salenum }</td>
						<td width="7%" align="center">${arts.category }</td>
						<td width="31%" align="center">${arts.description}</td>
						<td width="6%" align="center">
							<c:choose>
								<c:when test="${order.orderstatus==0 }">未支付</c:when>
								<c:when test="${order.orderstatus==1 }">
									<a href="${pageContext.request.contextPath}/ChangeOrderState?orderid=${order.orderid}&status=2">
										<strong>发货</strong> 
									</a>
								</c:when>
		...
		<TR>
			<td align="center" colSpan="4" class="sep1"><img
				src="${pageContext.request.contextPath}/salesperson/images/shim.gif">
			</td>
		</TR>
		<TR>
