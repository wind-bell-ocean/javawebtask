...
<head>
	...
	<title>导航栏</title>
	<link href="${pageContext.request.contextPath}/salesperson/css/left.css" rel="stylesheet" type="text/css">
</head>
	<body>
		...
		<table width="100%" border="0">
			  ...
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/logRecord" target="mainFrame" class="left_list">日志记录</a></td>
			  </tr>
		</table>
	</body>
</html>
