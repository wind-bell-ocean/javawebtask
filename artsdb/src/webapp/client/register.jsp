	...
	<div id="divcontent">
		<form action="${pageContext.request.contextPath}/register" method="post" onsubmit="return checkForm();">
			<table width="850px" border="0" cellspacing="0">
				<tr>
					<td style="padding: 30px; text-align: center"><h1>萌新报道</h1>
						<table width="70%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<td colspan="2"><span id="usernameMsg"></span><font color="#999999">字母数字下划线1到10位, 不以数字开头</font></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<input type="text" class="textinput"
									style="width: 150px" name="telephone" />
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
